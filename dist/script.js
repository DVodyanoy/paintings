...
/* harmony import */ var _modules_maskPhone__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/maskPhone */ "./src/js/modules/maskPhone.js");
...
/* harmony import */ var _modules_pictureView__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/pictureView */ "./src/js/modules/pictureView.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', '', '', true);
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_maskPhone__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="phone"]');
  ...
  Object(_modules_pictureView__WEBPACK_IMPORTED_MODULE_8__["default"])('.sizes-block');
...
var accordion = function accordion(triggers, items) {
...
var calcPrice = function calcPrice(size, material, options, promo, result) {
  ...
  var calcFunc = function calcFunc() {
    var sizeValue = Number(sizeBlock.value);
    var materialValue = Number(materialBlock.value);
    var optionsValue = Number(optionsBlock.value);
    var sum = Math.round(sizeValue * materialValue + optionsValue);
...
var drop = function drop() {
  ...
  var unHighLight = function unHighLight(item) {
    ...
    if (item.closest('.calc-form')) item.closest('.file_upload').style.backgroundColor = '#fff';else item.closest('.file_upload').style.backgroundColor = '#ededed';
    item.closest('.file_upload').style.borderRadius = '30px';
  };

  ['dragenter', 'dragleave', 'dragover', 'drop'].forEach(function (event) {
    fileInputs.forEach(function (input) {
      return input.addEventListener(event, preventDefaults, false);
    });
  });
...
var maskPhone = function maskPhone(selector) {
  ...
  function createMask(event) {
    ...
    this.value = matrix.replace(/./g, function (sym) {
      if (/[_\d]/.test(sym) && i < val.length) return val.charAt(i++);else if (i >= val.length) return '';else return sym;
    });
...
var modals = function modals() {
  ...
  var openByScroll = function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      ...
      var clientHeightView = document.documentElement.clientHeight;
...
var pictureView = function pictureView(selector) {
...
/* harmony default export */ __webpack_exports__["default"] = (pictureView);
...
var sliders = function sliders(slides, prev, next) {
  var isVerticalDir = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  var slideIndex = 1;
  var paused;
  ...
  var changeSlide = function changeSlide(index) {
    return showSlides(slideIndex += index);
  };
